<template>
  <div class=''>
    ...
    <div v-if="state.nextInterview" class="flex">
      ...
      <div class="flex-col-reverse ml-5">
        <div class="self-end">
    ...
    <div v-if="state.resumeLastInterview" class="mt-3 text-gray-600">
      <span>Última atualização do cúrriculo em </span><span class="font-bold">{{ new Date(state.resumeLastInterview).toLocaleDateString() }}</span>
    </div>
  </div>
</template>
